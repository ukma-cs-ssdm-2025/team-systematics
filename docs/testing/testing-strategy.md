...
Проєкт вже має фундамент автоматизованих тестів, які покривають ключові частини коду. Усі тести вже реалізовані, інтегровані в проєкт та включають як сценарії з мок-даними, так і повноцінні інтеграційні тести з реальною тестовою базою даних. Тестування розділене за рівнями відповідальності:
